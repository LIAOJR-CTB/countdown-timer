 ...
 pauseTimer = () => {
  ...
  render() {
    return (
      ...
      <View style={{
        height: 1200,
        //backgroundImage: `url('./img/BG-blur.png')`,
        backgroundImage: "url(" + require('./img/BG-blur-1.png')+")",
        backgroundSize: '100%,100%',
        backgroundColor: '#8CC152'

      }}>
        
        <Image style={styles.imgActive} source={require('./img/ICON-countdown.png')}></Image>
        ...
        <View style={styles.timerSetContainer}>
          <TimePicker color={colorWork} heading={'Study'} callback={this.WorkTimerCallback}/>
